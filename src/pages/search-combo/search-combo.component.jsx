  ...
  return (
    <>
      ...
      <main className="container">
          ...
          <div className="form-row">
            <div className="col-12 col-md-4 form-group">
              <input
                ...
                className="custom-search-inputs"
                id="town"
                type="text"
                name="town"
        ...
        <div id="search-images">{searchItems}</div>
      </main>
      <Footer />
    </>
  );
...
console.log("Hello:", selectFilteredProperties);
const mapDispatchToProps = (dispatch) => ({
  getResults: (filters) => dispatch(getResults(filters)),
});

export default connect(mapStateToProps, mapDispatchToProps)(SearchComboPage);
